...
// API
import { request_to_confirm_password_modification_of_professional_with_token } from "../../services_professional";

function ModifyPasswordWithoutLoginPage() {
...
export default ModifyPasswordWithoutLoginPage;
